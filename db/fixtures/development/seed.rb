...
AnswerSheet.seed(
  :id,
  { id: 1, point: 5, exam_id: 1, user_id: 2},
  { id: 2, point: 2, exam_id: 1, user_id: 3},
  { id: 3, point: 1, exam_id: 1, user_id: 4},
  { id: 4, point: 3, exam_id: 1, user_id: 5},
  { id: 5, point: 0, exam_id: 1, user_id: 6},

  { id: 6, point: 4, exam_id: 2, user_id: 2},
  { id: 7, point: 3, exam_id: 2, user_id: 3},
  { id: 8, point: 2, exam_id: 2, user_id: 4},
  { id: 9, point: 3, exam_id: 2, user_id: 5},
  { id: 10, point: 2, exam_id: 2, user_id: 6},

  { id: 11, point: 2, exam_id: 3, user_id: 2},
  { id: 12, point: 3, exam_id: 3, user_id: 3},
  { id: 13, point: 5, exam_id: 3, user_id: 4},
  { id: 14, point: 1, exam_id: 3, user_id: 5},
  { id: 15, point: 4, exam_id: 3, user_id: 6},

  { id: 16, point: 1, exam_id: 4, user_id: 2},
  { id: 17, point: 2, exam_id: 4, user_id: 3},
  { id: 18, point: 3, exam_id: 4, user_id: 4},
  { id: 19, point: 4, exam_id: 4, user_id: 5},
  { id: 20, point: 5, exam_id: 4, user_id: 6},

  { id: 21, point: 3, exam_id: 5, user_id: 2},
  { id: 22, point: 4, exam_id: 5, user_id: 3},
  { id: 23, point: 5, exam_id: 5, user_id: 4},
  { id: 24, point: 1, exam_id: 5, user_id: 5},
  { id: 25, point: 5, exam_id: 5, user_id: 6},
)
